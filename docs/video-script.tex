...
\begin{note}
\textbf{Always re-seed immediately before recording.} The opening shot depends
on Dr Mehta's first three slots being free, because they are the worked example
from the brief: \textbf{10:00, 10:20, 10:40}. If you have been clicking around,
those will be booked and the strongest visual in the video is gone.
\end{note}
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  ...
  \item Reset between takes with \texttt{npm run seed} (about three seconds).
\end{itemize}
...
\midrule
\endhead
Slots don't start at 10:00 & \texttt{npm run seed}, reload the console. \\
...
``This slot has already been booked'' & Left over from an earlier take. Re-seed. \\
